...
def run_clip(clip_id: str, *, device: str, samples: int, zoom: bool, crop_check: bool, temporal: bool, tag: str = "tail_grounded_v1", detector_id: str | None = None, classifier_id: str | None = None, time_scale: bool = False) -> dict:
