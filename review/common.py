...
PARTS = ["head", "spine", "front_paws", "hind_paws", "tail_curve", "tail_curve_anchored", "tail_curve_grounded", "tail_curve_grounded_v1", "tail_curve_grounded_v2"]
METHOD_FOR_PART = {
    "head": "body",
    "spine": "body",
    "front_paws": "body",
    ...
    "tail_curve_grounded_v2": "tail_grounded_v2",
}
