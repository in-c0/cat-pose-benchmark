...
namespace CatPose.StageS0
{
    ...
    public static class StageS0SyntheticExporter
    {
        ...
        private static GameObject BuildProxyScene(out Transform subjectRoot)
        {
            ...
            CreatePrimitive("body", PrimitiveType.Capsule, subjectRoot,
                new Vector3(0.0f, 0.38f, 0.0f), new Vector3(0.55f, 0.45f, 1.15f));
            CreatePrimitive("head", PrimitiveType.Sphere, subjectRoot,
                new Vector3(0.0f, 0.58f, 0.50f), new Vector3(0.48f, 0.42f, 0.46f));
            CreatePrimitive("floor", PrimitiveType.Cube, sceneRoot.transform,
                new Vector3(0.0f, -0.01f, 0.0f), new Vector3(3.0f, 0.02f, 4.0f));
            CreatePrimitive("box-left", PrimitiveType.Cube, sceneRoot.transform,
                new Vector3(-0.8f, 0.25f, 0.4f), new Vector3(0.35f, 0.5f, 0.35f));
            CreatePrimitive("box-right", PrimitiveType.Cube, sceneRoot.transform,
                new Vector3(0.8f, 0.25f, 0.4f), new Vector3(0.35f, 0.5f, 0.35f));
