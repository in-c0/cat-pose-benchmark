...
- **05 (20 Sep 2026):** [*Frozen truth: ten passes against fixed frame labels, and a prospective holdout that undid one of them*](paper/05-frozen-truth/README.md) ([PDF](paper/05-frozen-truth/frozen-truth-v0.1.pdf)). A written-down frame truth (147 dev frames, model-annotated, human pass pending) replaces the proxy. One change survives twelve reviewer passes: a two-sided SAM2 bridge (v3), precision 0.953, recall 0.911. Six ideas rejected on the same truth. Four holdout clips chosen by a precommitted metadata-only protocol and annotated before inference: the bridge gains nothing, and a rump patch is read as a tail for 17 frames. Precision on unseen video 0.70.
